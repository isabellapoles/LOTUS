...
# DISCLAIMER: This code is strongly influenced by https://github.com/hunto/DiffKD, https://github.com/pesser/pytorch_diffusion
# https://github.com/hojonathanho/diffusion and https://github.com/hunto/image_classification_sota 
...
class DDIMScheduler():
    ...
    def add_noise_diff2(
        ...
        return noisy_samples, torch.mean(alpha_prod)
